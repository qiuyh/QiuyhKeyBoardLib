...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "qiuyh"
  # s.authors            = { "qiuyh" => "1039724903@qq.com" }
  # s.social_media_url   = "http://twitter.com/qiuyh"
  ...
  s.ios.vendored_libraries = 'Classes/QYHKeyBoardManager.a'
